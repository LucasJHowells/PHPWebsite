...
class MasterPage
{
    ...
    private function setPageDefaults()
    {
        ...
        $this->addCSSFile("bootstrap.superhero.css");
    ...
    private function setDynamicDefaults()
    {
        ...
        <p>Lucas Howells - LJMU &copy; {$tcurryear}</p>
        FOOTER;
    }
        	...
        	<div class="header clearfix">
        		<nav>
        			...
        			<ul class="nav nav-pills pull-right">
                        ...
                        <li role="presentation"><a href="review_entry.php">Review Entry</a></li>
                        <li role="presentation"><a href="app_formtest.php">Sign Up</a></li>
        			</ul>
        			<h3 class="text-muted"><a href="index.php">Our Games Site</a></h3>
        		</nav>
        	</div>
        	<div class="jumbotron">
        		{$this->_dynamic_1}
